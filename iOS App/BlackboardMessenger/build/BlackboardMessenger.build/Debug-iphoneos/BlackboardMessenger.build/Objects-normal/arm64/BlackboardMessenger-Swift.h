...
SWIFT_CLASS("_TtC19BlackboardMessenger32AnnouncementsTableViewController")
...
SWIFT_CLASS("_TtC19BlackboardMessenger11AppDelegate")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified messageContent;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC19BlackboardMessenger10RosterCell")
@interface RosterCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified rosterNameCell;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC19BlackboardMessenger25RosterTableViewController")
@interface RosterTableViewController : UITableViewController
@property (nonatomic, strong) NSArray * _Null_unspecified roster;
@property (nonatomic, strong) NSUserDefaults * _Null_unspecified userDefaults;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
...
@interface UITableView (SWIFT_EXTENSION(BlackboardMessenger))
- (void)scrollToBottom;
@end
